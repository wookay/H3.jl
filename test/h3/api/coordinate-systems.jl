...
using Test
using H3.API # Vec2d Vec3d CoordIJK FaceIJK ijToIjk ijkToHex2d ijkToIj ijkDistance ijkNormalize cellToLocalIjk h3ToFaceIjk localIjkToCell faceIjkToH3 hex2dToCoordIJK geoToVec3d geoToFaceIjk
...
@test localIjkToCell(h, ijk) == 0x0851c29c7fffffff
@test cellToLocalIjk(h, 0x0851c29c7fffffff) == ijk
...
geo = cellToLatLng(h)
@test geo == LatLng(0.6518070561696664, -2.128889370371519)
@test latLngToCell(geo, 5) == h
